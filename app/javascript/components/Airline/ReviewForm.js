...
const ReviewForm = (props) =>{
  ...
  const ratingOptions = [5,4,3,2,1].map((score, index) => {
    return (
      <Fragment key={index}>
        <input type="radio" value={score} checked={props.review.score == score} onChange={() => {props.review.score = score}} name="rating" id={`rating-${score}`}/>
  ...
  return (
    ...
    <ReviewWrapper>
      <form onSubmit={props.handleSubmit}>
        ...
        <Field>
          <input onChange={props.handleChange} type="text" name="description" placeholder="Review Description" defaultValue={props.review.description}/>
        </Field>
        <Field>
          <RatingContainer>
